...
def get_user_data() -> str:
    """
    Placeholder: Retrieve user-specific data for bill processing.
    This could be from a database, config file, or environment variable.
    """
...
use below user data and add the name information
```json
{users}
```
-------------------------
