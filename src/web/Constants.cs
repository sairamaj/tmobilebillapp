...
internal static class Constants
{
    ...
    public static string UsersUrl = "https://9roffaomve.execute-api.us-west-2.amazonaws.com/Prod/api/phone/users";
    public static string BillsUrl = "https://9roffaomve.execute-api.us-west-2.amazonaws.com/Prod/api/phone/bills";
    public static string GetBillDetailsUrl(string yearMonth) => $"https://9roffaomve.execute-api.us-west-2.amazonaws.com/Prod/api/phone/bills/{yearMonth}";
    public static string GetDownloadGenerateLinkUrl(string yearMonth) => $"https://9roffaomve.execute-api.us-west-2.amazonaws.com/Prod/api/phone/links/bills/{yearMonth}";
